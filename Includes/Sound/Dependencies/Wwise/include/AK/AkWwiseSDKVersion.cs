...
namespace AK
{
	namespace Wwise
	{
		public static class Version
		{
            ...
            /// String representing the Wwise SDK version
            /// </summary>
            public const string AssemblyVersion = "2013.1.1.4677";

			/// <summary>
			/// String representing the Wwise SDK copyright notice
			/// </summary>
            public const string CopyrightNotice = "\xA9 Audiokinetic Inc. 2006-2013. All rights reserved.";
