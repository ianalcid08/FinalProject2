...
namespace AK
{
	namespace SoundEngine
	{
		...
		{
			AKRESULT eFinal = AK_Success;
#if ( defined( AK_WIN ) && !defined( AK_USE_METRO_API ) ) || defined( AK_XBOX360 ) || defined( AK_PS3 ) || defined( AK_DIEGO )
			AK_CHECK_ERROR( AK::SoundEngine::RegisterPlugin( 
				AkPluginTypeEffect, 
				AKCOMPANYID_IZOTOPE, 
...
#endif
#if ( defined( AK_WIN ) && !defined( AK_USE_METRO_API ) ) || defined( AK_XBOX360 )
