...
// Output devices.
static const AkUInt32					AK_DEFAULT_OUTPUT_DEVICE			=  0;					///< Default output device (see AK::SoundEngine::RouteListenersToDevice)
...
public:
	...
	/// Get distance.
	AkForceInline AkReal32 Distance() const { return r; }

	/// Get azimuth angle, in radians. Positive direction is towards the right.
	AkForceInline AkReal32 Azimuth() const { return theta; }

	/// Get elevation angle, in radians. Positive direction is towards the top.
	AkForceInline AkReal32 Elevation() const { return phi; }
	...
	AkForceInline AkReal32 EmitterAngle() const { return fEmitterAngle; }
...
#ifdef AK_71AUDIO
#define AK_NUM_PLATFORM_CHANNELS	(8)
#elif defined AK_LFECENTER && defined AK_REARCHANNELS
#define AK_NUM_PLATFORM_CHANNELS	(6)
#else
#define AK_NUM_PLATFORM_CHANNELS	(2)
#endif
