...
enum AkSinkType
{
	AkSink_Detect,			///< Try XAudio2 first, then DirectSound.
	AkSink_XAudio2,			///< XAudio2 (better performance on Windows post-Vista).
	AkSink_DirectSound		///< DirectSound (for backward compatibility).
};
...
struct AkPlatformInitSettings
{
	...
	AkSinkType			eSinkType;				///< API used for audio output, default = AkSink_Detect.
...
namespace AK
{
	...
	AK_EXTERNFUNC( IXAudio2 *, GetWwiseXAudio2Interface )();
