...
namespace MotionEngine
{
	...
	AK_EXTERNAPIFUNC( AKRESULT, AddPlayerMotionDevice )(
		...
		void* in_pDevice = NULL			///< \if PS4 Device handle, returned by scePadOpen. \elseif Windows Direct Input Device reference for DirectInput. NULL to use XInput. \elseif WiiU Use AK_MOTION_WIIMOTE_DEVICE to add a Wiimote or AK_MOTION_DRC_DEVICE to add a DRC device. \else Unused on this platform \endif
		);
